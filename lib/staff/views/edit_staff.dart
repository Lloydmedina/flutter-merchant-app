...
class EditStaff extends StatefulWidget {
  @override
  EditStaffState createState() => EditStaffState();
}

class EditStaffState extends State<EditStaff> {
  bool obscureText = true;
  String dropdownValueStaff = 'Cashier';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: _appBar(),
      body: _addStaffForm(),
      bottomNavigationBar: _saveStaff(),
    );
  }
  ...
  Widget _emailField() {
    return Container(
      ...
      child: TextFormField(
        initialValue: 'staff@passafood.co',
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          hintText: 'Email',
          contentPadding: EdgeInsets.all(16),
    ...
    showDialog(
        ...
        builder: (context) {
          return CustomDialog(
              title: 'Delete Staff?',
              content: Text(
                'This staff account will not be available anymore.',
