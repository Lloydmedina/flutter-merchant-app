...
class AllOrdersView extends StatefulWidget {
  @override
  AllOrdersViewState createState() => AllOrdersViewState();
}

class AllOrdersViewState extends State<AllOrdersView>
    with SingleTickerProviderStateMixin<AllOrdersView> {
